...
for filename in files:
    ...
    # plot the results
    axs[0, count].plot(X[:limit, np.arange(0, nx, nx_l)], linewidth=0.25, rasterized = True)
    axs[1, count].plot(X[:limit, np.arange(1, nx, nx_l)], linewidth=0.25, rasterized = True)
